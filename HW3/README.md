The "bert_question_answering.ipynb" file contains the entire code including the data loading, data pre-processing, tokenizing, training, testing and scoring.
